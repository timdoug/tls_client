...
void shake128_init(shake128_ctx *ctx) { memset(ctx,0,sizeof(*ctx)); }
...
/* ML-KEM768 Encaps */
void mlkem768_encaps(const uint8_t ek[1184],
...
void mlkem768_decaps(const uint8_t dk[2400], const uint8_t ct[1088],
                             uint8_t ss[32]) {
...
void x25519_scalar_mult(const uint8_t scalar[32],
...
int x25519_shared_secret(const uint8_t priv[X25519_KEY_LEN],
